...
for i in range(4):
    with open(f"/workdir/work/icefall/egs/tencent/SSL/tem_data/kmeans_iter1_list_{i}", 'w') as f:
        f.write("\n".join(result[i::4]))
with open(f"/workdir/work/icefall/egs/tencent/SSL/tem_data/kmeans_iter1_list_dev", 'w') as f:
