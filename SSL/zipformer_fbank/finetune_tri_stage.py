...
def run(rank, world_size, args):
    ...
    if params.train_cuts == "nst":
        train_cuts = finetune_datamoddule.train_cuts_vi_nst(suffix = "_"+params.label_type)
        ...
        train_cuts = finetune_datamoddule.train_100h_cuts()
    elif params.train_cuts == "50h_cv_fleurs":
        train_cuts = [finetune_datamoddule.train_50h_cuts(), finetune_datamoddule.train_cv_cuts(), finetune_datamoddule.train_fleurs_cuts()]
        # train_cuts = [finetune_datamoddule.train_50h_cuts()]+[finetune_datamoddule.train_fleurs_cuts()]*2
        train_cuts = CutSet.mux(*train_cuts, weights=[len(item) for item in train_cuts])
    elif params.train_cuts == "50h_fleurs":
        # train_cuts = [finetune_datamoddule.train_50h_cuts(), finetune_datamoddule.train_cv_cuts(), finetune_datamoddule.train_fleurs_cuts()]
        train_cuts = [finetune_datamoddule.train_50h_cuts()]+[finetune_datamoddule.train_fleurs_cuts()]*2
        train_cuts = CutSet.mux(*train_cuts, weights=[len(item) for item in train_cuts])
    elif params.train_cuts == "50h_cv_fleurs2":
        train_cuts = finetune_datamoddule.train_50h_cuts()
        train_cuts += finetune_datamoddule.train_cv_cuts()
        train_cuts += finetune_datamoddule.train_fleurs_cuts()
