...
if __name__=="__main__":
    ...
    parser.add_argument("--target-duration", type=float, default=100, help="Duration for target cut in hours")
    parser.add_argument("--target-path", type=float, default=100, help="Duration for target cut in hours")
    ...
    for i, index in range(num_splits):
        ...
        cuts_path = os.path.join(src_dir, f"vietASR-ssl_cuts_{subset_name}.{idx}.jsonl.gz")
